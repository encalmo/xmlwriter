...
- [Output types: String, Streaming, and Document](#output-types:-string,-streaming,-and-document)
   ...
   - [4. Document output (DOM) with Namespace](#4.-document-output-(dom)-with-namespace)
   - [5. Document output (DOM) with Namespace Mapping](#5.-document-output-(dom)-with-namespace-mapping)
